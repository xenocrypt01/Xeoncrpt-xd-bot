 ...
 client.ev.on('call', async (callData) => {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Congrats, XΞNØCRYPT-BOT has successfully connected to this server", "green"));
      ...
      client.sendMessage(client.user.id, { text: `holla » » »【XΞNØCRYPT 𝐁𝐎𝐓】 ` });
    }
  });
